...
struct CardSwipeView: View {
    ...
    var body: some View {
                ...
                VStack {
                    ...
                    ZStack {
                        VStack {
                            ...
                            Text("Foodie\nCardSwipe")
                                .font(.custom("ChakraPetch-Bold", size: 60))
        ...
        .sheet(isPresented: $showResultSheet) {
            if showResultSheet {
                CardSwipeResultView(filters: $filters, radius: $radius, selectedSearchLogic: $selectedSearchLogic, showResultSheet: $showResultSheet)
            }
        }
